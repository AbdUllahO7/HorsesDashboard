  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-[#1E1E2D]">إدارة المزادات</h1>
          <p className="text-xs text-[#8E8E93] mt-1">متابعة وإدارة مزادات الخيول المباشرة والمنتهية</p>
        </div>
      ...
      <div className="rounded-2xl border border-[#EDEEF2] bg-white p-12 text-center shadow-2xs">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[#FAF4E8] border border-[#EADBBD] text-[#A6883C] mb-4">
          <Gavel className="h-8 w-8" strokeWidth={1.8} />
        </div>
        <h3 className="text-base font-bold text-[#1E1E2D]">وحدة إدارة المزادات</h3>
        <p className="text-xs text-[#8E8E93] max-w-sm mx-auto mt-2">
          تم تجهيز الـ Types والـ Services الخاصة بالمزادات داخل `src/features/auctions` جاهزة للربط مع الـ Backend API.
        </p>
      </div>
    </div>
  );
